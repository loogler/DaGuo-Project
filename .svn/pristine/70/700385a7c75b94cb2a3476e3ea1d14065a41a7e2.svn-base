package com.daguo.modem.writeshuoshuo.adapter;
...
import com.daguo.modem.writeshuoshuo.ui.AlbumActivity;
import com.daguo.modem.writeshuoshuo.ui.ShowAllPhoto;
import com.daguo.modem.writeshuoshuo.util.BitmapCache;
import com.daguo.modem.writeshuoshuo.util.BitmapCache.ImageCallback;
...
* @version 创建时间：2015-12-9 下午4:01:54
* @function ：这个是显示所有包含图片的文件夹的适配器
 */
