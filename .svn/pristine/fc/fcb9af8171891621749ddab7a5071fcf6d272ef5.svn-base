...
public class Main_4Aty extends Activity implements OnClickListener {
	...
	public void onClick(View arg0) {
		...
		case R.id.xieyi:// 用户协议
			...
			// Toast.LENGTH_SHORT).show();
			intent = new Intent(Main_4Aty.this, UserAgreementAty.class);
		...
		case R.id.tuijian:// 推荐给好友
			// Toast.makeText(Main_4Aty.this, "推荐给好友",
			// Toast.LENGTH_SHORT).show();
			String txt = "Hi,我发现一款好玩的校园应用，社团、课程表、同学说什么都有哎，还能认识校园的新朋友，快点点击传送门加入吧：http://115.29.224.248:8080/DGXYDL/download/download.html";

			Intent sendIntent = new Intent();
			sendIntent.setAction(Intent.ACTION_SEND);
			sendIntent.putExtra(Intent.EXTRA_TEXT, txt);// 分享内容
