 ...
 * @version 创建时间：2016-1-28 上午10:58:18
 * @function ： 已付款订单的主界面
 */
public class UserInfo_MyOrder_PayAty extends Activity{
	...
	setContentView(R.layout.aty_userinfo_myorder_pay);
	...
	new Thread(new Runnable() {
		...
		try {
		    String url = HttpUtil.QUERY_MYORDER + "&rows=15&page="
			    + pageIndex + "&p_id=" + p_id+"&pay_status=1";
