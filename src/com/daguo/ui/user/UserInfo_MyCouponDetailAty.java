...
public class UserInfo_MyCouponDetailAty extends Activity {
	...
	public void handleMessage(Message msg) {
		...
		Toast.makeText(UserInfo_MyCouponDetailAty.this, "提交失败，请重试",
	...
	initContentData();
	initFeedbackData();
	adapter = new SC_SheTuanDetailAdapter(UserInfo_MyCouponDetailAty.this,
		evaLists);
	...
	headView = LayoutInflater.from(UserInfo_MyCouponDetailAty.this)
		.inflate(R.layout.item_sc_xinwen_eva_adapter, null);
	...
	new Thread(new Runnable() {
		...
		try {
		    String url = HttpUtil.QUERY_EVENT
			    + "&menu_id=cc4dc0d1-fee5-4454-88cb-b658ac707a93&rows=1&page=1&id="
			    + id;
	...
	if (feedbackContent != null && !"".equals(feedbackContent)
	    ...
	    Toast.makeText(UserInfo_MyCouponDetailAty.this, "评价内容为空",
		    Toast.LENGTH_LONG).show();
