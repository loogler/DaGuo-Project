...
public class UserInfo_MyCouponAty extends Activity {
	...
	LayoutParams params = new LayoutParams(
		GetScreenRecUtil.getWindowWidth(UserInfo_MyCouponAty.this),
		GetScreenRecUtil.getWindowWidth(UserInfo_MyCouponAty.this) / 2);
	...
	public Object instantiateItem(View container, final int position) {
	    ...
	    FinalBitmap.create(UserInfo_MyCouponAty.this).display(
	    ...
	    mImageViews[position]
			...
			@Override
			public void onClick(View arg0) {
			    new AddBannerOnclickListener(
				    UserInfo_MyCouponAty.this, addLists,
				    position);
			}
		    });
	...
	xinWenAdapter = new NewsAdapter(UserInfo_MyCouponAty.this, xinWenLists);
	...
	new Thread(new Runnable() {
		...
		String url = HttpUtil.QUERY_EVENT
			+ "&menu_id=cc4dc0d1-fee5-4454-88cb-b658ac707a93&rows=10&page="
			+ pageIndex;
		try {
