 ...
 * @version 创建时间：2016-1-27 下午3:45:52
 * @function ：看天下主界面
 */
public class WorldViewAty extends Activity {
	...
	private void setTopBanner() {
		...
		LayoutParams params = new LayoutParams(
				GetScreenRecUtil.getWindowWidth(WorldViewAty.this),
				2 * GetScreenRecUtil.getWindowWidth(WorldViewAty.this) / 5);
	...
	public class MyAdapter extends PagerAdapter {
		...
		public Object instantiateItem(View container, final int position) {
			...
			FinalBitmap.create(WorldViewAty.this).display(
			...
			mImageViews[position]
					.setOnClickListener(new AddBannerOnclickListener(
							WorldViewAty.this, addLists, position));
	...
	private void initXinWenViews() {
		...
		xinWenAdapter = new NewsAdapter(WorldViewAty.this, xinWenLists);
		...
		content_view.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View v, int p,
				...
				Intent intent = new Intent(WorldViewAty.this,
						WorldViewDetailAty.class);
		...
		new Thread(new Runnable() {
			public void run() {
				String url = HttpUtil.QUERY_EVENT
						+ "&menu_id=e1b218a8-6514-48c6-8e1e-8227862d8a70&rows=10&page="
						+ pageIndex;
				try {
