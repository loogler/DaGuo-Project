 ...
 * @version 创建时间：2016-1-27 下午4:10:11
 * @function ： 看世界主界面
 */
public class WorldViewDetailAty extends Activity {
	...
	public void handleMessage(Message msg) {
		...
		Toast.makeText(WorldViewDetailAty.this, "提交失败，请重试",
	...
	initContentData();
	initFeedbackData();
	adapter = new SC_SheTuanDetailAdapter(WorldViewDetailAty.this, evaLists);
	...
	headView = LayoutInflater.from(WorldViewDetailAty.this).inflate(
	...
	new Thread(new Runnable() {
		...
		try {
		    String url = HttpUtil.QUERY_EVENT
			    + "&menu_id=e1b218a8-6514-48c6-8e1e-8227862d8a70&rows=1&page=1&id="
			    + id;
	...
	new Runnable() {
		...
		String url = HttpUtil.QUERY_EVENT_DETAIL
			+ "&menu_id=e1b218a8-6514-48c6-8e1e-8227862d8a70&a_id="
	...
	if (feedbackContent != null && !"".equals(feedbackContent)
	    ...
	    Toast.makeText(WorldViewDetailAty.this, "评价内容为空", Toast.LENGTH_LONG)
		    .show();
