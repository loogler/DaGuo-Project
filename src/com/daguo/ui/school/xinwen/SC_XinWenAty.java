 ...
 * @version 创建时间：2015-12-2 上午11:34:07
 * @function ：校园新闻主界面
 */
public class SC_XinWenAty extends Activity {
	...
	public class MyAdapter extends PagerAdapter {
		...
		public Object instantiateItem(View container, final int position) {
			...
			FinalBitmap.create(SC_XinWenAty.this).display(
	...
	private void initXinWenViews() {
		...
		xinWenAdapter = new NewsAdapter(SC_XinWenAty.this, xinWenLists);
		...
		content_view.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View v, int p,
				...
				Intent intent = new Intent(SC_XinWenAty.this,
		...
		new Thread(new Runnable() {
			public void run() {
				String url = HttpUtil.QUERY_EVENT
						+ "&menu_id=db94a88d-5c78-448b-a3a7-4af1c3850571&rows=10&page="
						+ pageIndex;
				try {
