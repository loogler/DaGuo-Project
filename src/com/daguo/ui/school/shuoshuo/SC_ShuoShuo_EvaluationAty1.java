...
import com.daguo.util.adapter.SC_Thumb_HeadInfo_Small_Adapter;
...
public class SC_ShuoShuo_EvaluationAty1 extends Activity implements
	...
	private void setContentData() {
		...
		if (contentList.getSigns() == null || contentList.getSigns().isEmpty()) {
			...
			final List<HeadInfo> headInfos = contentList.getSigns();
			...
			photo_grid.setAdapter(new SC_Thumb_HeadInfo_Small_Adapter(str,
					SC_ShuoShuo_EvaluationAty1.this));
			photo_grid.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View v, int p,
					...
					Intent intent = new Intent(SC_ShuoShuo_EvaluationAty1.this,
							UserInfoAty.class);
					intent.putExtra("id", headInfos.get(p).getId());
	...
	public void onClick(View v) {
		...
		case R.id.photo:
			...
			imageBrower(
					0,
					new String[] { HttpUtil.IMG_URL + contentList.getP_photo() });
			break;
