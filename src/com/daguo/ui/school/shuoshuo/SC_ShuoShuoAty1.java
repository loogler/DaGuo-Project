 ...
 * @author BugsRabbit
 * @version 创建时间：2016-2-3 上午10:46:56
 * @function 功能:显示说说内容的界面，包含了四个小界面fragment ，分类说说。
 */
public class SC_ShuoShuoAty1 extends FragmentActivity {
	...
	private TextView remenTextView, zuixinTextView, benxiaoTextView,
			fujinTextView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		backButton = (ImageView) findViewById(R.id.friend_back);
	...
	private void init() {
		...
		remenTextView.setOnClickListener(new MyOnClickListener(0));
		zuixinTextView.setOnClickListener(new MyOnClickListener(1));
		benxiaoTextView.setOnClickListener(new MyOnClickListener(2));
		fujinTextView.setOnClickListener(new MyOnClickListener(3));
	 ...
	 * 翻页适配器
	 * 
	 * @author Bugs_Rabbit 時間： 2015-9-22 下午3:54:51
	 */
	public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			case 0:
				...
				reSetBackGround();
				remenTextView.setTextColor(getResources().getColor(
						R.color.green_home));
				if (currIndex == 1) {
			...
			case 1:
				mTab2.setImageDrawable(getResources().getDrawable(
						R.drawable.sc_shuoshuo_tab_back));
				reSetBackGround();
				zuixinTextView.setTextColor(getResources().getColor(
						R.color.green_home));
				if (currIndex == 0) {
			...
			case 2:
				mTab3.setImageDrawable(getResources().getDrawable(
						R.drawable.sc_shuoshuo_tab_back));
				reSetBackGround();
				benxiaoTextView.setTextColor(getResources().getColor(
						R.color.green_home));
				if (currIndex == 0) {
			...
			case 3:
				mTab4.setImageDrawable(getResources().getDrawable(
						R.drawable.sc_shuoshuo_tab_back));
				reSetBackGround();
				fujinTextView.setTextColor(getResources().getColor(
						R.color.green_home));
				if (currIndex == 0) {
	 ...
	 * 页码适配
	 * 
	 * @author Bugs_Rabbit 時間： 2015-9-22 下午3:55:15
	 */
