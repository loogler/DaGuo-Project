 ...
 * @version 创建时间：2015-11-30 下午2:59:22
 * @function ：
 */
public class SC_SheTuanAdapter extends BaseAdapter {

    Activity activity;
    List<SC_SheTuan> lists;

    public SC_SheTuanAdapter(Activity activity, List<SC_SheTuan> lists) {
