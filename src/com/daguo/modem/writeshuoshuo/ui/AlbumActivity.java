...
import com.daguo.R;
import com.daguo.modem.writeshuoshuo.adapter.AlbumGridViewAdapter;
import com.daguo.modem.writeshuoshuo.util.AlbumHelper;
import com.daguo.modem.writeshuoshuo.util.Bimp;
import com.daguo.modem.writeshuoshuo.util.ImageBucket;
 ...
 * @version 创建时间：2015-12-9 下午4:04:25
 * @function ：这个是进入相册显示所有图片的界面
 */
public class AlbumActivity extends Activity {
	...
	isShowOkBt();
	setResult(TRIM_MEMORY_COMPLETE);
    }
