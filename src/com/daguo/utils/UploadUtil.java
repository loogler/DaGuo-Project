 ...
 * 上传文件到服务器
 * 
 * @author Bugs_Rabbit 時間： 2015-8-6 下午7:46:38
 */
public class UploadUtil {
    ...
    /**
     * 用於適用於說說模塊的僅僅只用bitmap作爲傳遞的方法，用於提交文件到服務器。把file直接轉爲inputstream！
     * 
     * @param is
     * @param RequestURL
     * @return 狀態碼
	...
	try {
		 ...
		 * filename是文件的名字，包含后缀名的 比如:abc.png
		 */
		String fileName = new SimpleDateFormat("'IMG'_yyyyMMdd_HHmmss")
