 ...
 * @version 创建时间：2015-11-27 上午10:51:44
 * @function ： 真正实现3d效果切换的支撑，用framelayout座位容器承载view图片。
 */
public class FrameLayout_3DBanner extends FrameLayout implements Animatable {
	...
	public FrameLayout_3DBanner(Context context) {
		super(context);
		init();
	}

	public FrameLayout_3DBanner(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public FrameLayout_3DBanner(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		if (mOutlinePaint.getColor() != ViewPager_3DBanner.sOutlineColor) {
			mOutlinePaint.setColor(ViewPager_3DBanner.sOutlineColor);
		}
