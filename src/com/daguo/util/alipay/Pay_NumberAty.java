...
//import com.daguo.ui.operators.Oper_MobileAty;
//import com.daguo.ui.operators.MoblieOrderAty;
//import com.daguo.utils.HttpUtil;
//
//public class Pay_NumberAty extends FragmentActivity{
//
//
...
//					Toast.makeText(Pay_NumberAty.this, "支付成功",
//							Toast.LENGTH_SHORT).show();
//					new Submit_Pay_statusThread().start();
//					Intent intent = new Intent(Pay_NumberAty.this,
//							ChouJiangAty.class);
...
//						Toast.makeText(Pay_NumberAty.this, "支付结果确认中",
//								Toast.LENGTH_SHORT).show();
//
//					} else {
//						Toast.makeText(Pay_NumberAty.this, "支付失败",
//								Toast.LENGTH_SHORT).show();
//
//					}
//				}
...
//			}
//			case SDK_CHECK_FLAG: {
//				Toast.makeText(Pay_NumberAty.this, "检查结果为：" + msg.obj,
//						Toast.LENGTH_SHORT).show();
//				break;
//			}
//			default:
...
//				map.put("id", MoblieOrderAty.num_orderId);
...
////		String name = Oper_MobileAty.num_tel;
////		String price = Oper_MobileAty.num_price;
////		String detail =Oper_MobileAty.num_bz;
...
//			public void run() {
//				// 构造PayTask 对象
//				PayTask alipay = new PayTask(Pay_NumberAty.this);
//				// 调用支付接口
...
//			@Override
//			public void run() {
//				PayTask payTask = new PayTask(Pay_NumberAty.this);
